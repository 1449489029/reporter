...
/* Admin/AddItem.html */
class __TwigTemplate_d2d232e05ca2a4a62631e21bee9e438f5dfe741bd78e2c34e44e7da1e3e37cd6 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("base.html", "Admin/AddItem.html", 1);
...
{% endblock %}", "Admin/AddItem.html", "D:\\phpstudy_pro\\WWW\\chenbingji\\reporter\\application\\index\\view\\admin\\AddItem.html");
    }
}
